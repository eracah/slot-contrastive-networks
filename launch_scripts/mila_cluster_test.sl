...
python -m scripts.eval --wandb-proj coors-production --run-dir $SLURM_TMPDIR/eval_runs --train-run-parent-dir $SLURM_TMPDIR/wandb --num-frames 2000 --epochs 2 --batch-size 32
